...
const POLL_DEAD_THRESHOLD_MS = 8 * 60 * 1000; // 8 min of no poll activity → treat as dead during Tide check
...
/**
 * Called by Tide on each cycle to detect and heal a dead polling loop.
