...
function buildAvatarPrompt(title) {
  ...
  return (
    `Close-up portrait headshot of an AI persona named "${name}". ` +
    'Near-photorealistic, cinematic lighting, shallow depth of field, neutral studio background. ' +
    'Face fills the frame, sharp eyes, confident expression. ' +
    'No text, no logos, no full body. Professional LinkedIn-style profile photo aesthetic.'
  );
}
