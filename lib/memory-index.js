...
export function getMemoryIndex(config) {
  ...
  return {
    ...
    async search(query, opts = {}) {
      await sync(config);
      const searchConfig = (opts.dateFrom != null || opts.dateTo != null || opts.maxResults != null)
        ? { ...config, search: { ...config.search, dateFrom: opts.dateFrom ?? undefined, dateTo: opts.dateTo ?? undefined, maxResults: opts.maxResults ?? config.search.maxResults } }
        : config;
